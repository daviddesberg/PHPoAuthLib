...
class MondoTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationEndpoint()
    {
        ...
        $this->assertSame('https://auth.getmondo.co.uk', $service->getAuthorizationEndpoint()->getAbsoluteUri());
    }
    ...
    public function testGetAccessTokenEndpoint()
    {
        ...
        $this->assertSame('https://api.getmondo.co.uk/oauth2/token', $service->getAccessTokenEndpoint()->getAbsoluteUri());
    }
