...
if (!empty($_GET['code'])) {
    ...
    $result = json_decode($dailymotionService->request('/me?fields=email,screenname'), true);

    echo'<pre>';print_r($result);exit;

    // Show some of the resultant data
    //echo 'Your unique Dailymotion user id is: ' . $result['user_id'] . ' and your name is ' . $result['name'];
