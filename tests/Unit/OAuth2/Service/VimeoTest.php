...
class VimeoTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationEndpoint()
    {
        ...
        $this->assertSame('https://api.vimeo.com/oauth/authorize', $service->getAuthorizationEndpoint()->getAbsoluteUri());
    }
    ...
    public function testGetAccessTokenEndpoint()
    {
        ...
        $this->assertSame('https://api.vimeo.com/oauth/access_token', $service->getAccessTokenEndpoint()->getAbsoluteUri());
    }
    ...
    public function testParseAccessTokenResponseValidWithoutRefreshToken()
    {
        ...
        $token = $service->requestAccessToken('foo');
        $this->assertInstanceOf('\\OAuth\\OAuth2\\Token\\StdOAuth2Token', $token);
        $this->assertEquals(time()+3600, $token->getEndOfLife(), 'Expected End of life mismatch', 1);
    ...
    public function testParseAccessTokenResponseValidWithRefreshToken()
    {
        ...
        $this->assertInstanceOf('\\OAuth\\OAuth2\\Token\\StdOAuth2Token', $token);
        $this->assertEquals(time()+3600, $token->getEndOfLife(), 'Expected End of life mismatch', 1);
        $this->assertEquals('baz', $token->getRefreshToken());
        $this->assertEquals('foo', $token->getAccessToken());
    }
